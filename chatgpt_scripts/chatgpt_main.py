...
class ChatGPTExpert:
    def __init__(self, api_key: str, model_name: str):
        ...
        self.ingredient_prompt = "У меня есть состав продукта:"
        self.ingredient_prompt_end = "Найди в составе все пищевые добавки: они могут быть написаны в формате Е или только текстом, напиши о них в формате Е, " + \
            "к каждой добавке в скобках добавь ее название \n Учти, что добавки, которые есть в составе, но указаны не в формате Е тоже нужно написать." + \
            "Каждой такой добавке добавь ее номер. если добавка соответствует наиболее распространенным видам добавок, то присвой ей общий номер\n" + \
            "Нужно выдать ответ в формате: Номер добавки (название добавки), и ее тип"
